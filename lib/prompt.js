...
4. oilImpact: "none" for single/raw; "low" for lightly cooked; "medium" for typical sabji/bhurji/curry; "high" for fried or rich gravies.
...
6. PORTION INTELLIGENCE: interpret "1 bowl", "1 katori", "1 plate", "1 serving", "1 piece", "2 roti", "half bowl", "small/medium/large bowl", "thoda", "thodi si", "aadha", "half", "full", "some". Use food-specific portion references; do NOT assume every bowl is 200g. Set size small/medium/large accordingly and quantity/unit. A gram weight goes in estimatedGrams (single) or finishedWeightGrams (recipe). "1 plate" -> unit:"plate". "1 bowl/katori" -> unit:"bowl". "2 roti" -> unit:"piece", quantity:2.
