...
2. type: "single" (raw/as-is: butter, paneer, rice, curd, banana), "dish" (EXACT DB match → set indbName; oil already included, never ask oil_level), "recipe" (homemade built from ingredients: bhurji, sabji, dal tadka, pyaaz paratha, soya chaap masala, paneer butter masala — list ingredients+grams; cooking-fat line isCookingFat=true, estimatedGrams=0), "product" (branded — fill productLabel from the sachet; engine distributes one sachet across servings, never multiplies by serving count). For "recipe": ALWAYS list EVERY main ingredient (base/staple + each vegetable/protein + sauce + cooking fat) with realistic grams — NEVER return only a cooking-fat line. The dish's namesake food MUST appear as role="base" with realistic grams (e.g. "honey chilli potato"→potato~120g base+honey~20g+oil isCookingFat; "chilli paneer"→paneer~100g base+capsicum+oil; "veg manchurian"→fried veg balls~100g+sauce+oil).
